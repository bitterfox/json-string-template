...
- [Jakarta JSON Processing™ API](https://projects.eclipse.org/projects/ee4j.jsonp)
  - [io.github.bitterfox:json-string-template-jakarta-json:0.21.0](https://central.sonatype.com/artifact/io.github.bitterfox/json-string-template-jakarta-json)
- [JSON in Java a.k.a. org.json](https://github.com/stleary/JSON-java)
  - [io.github.bitterfox:json-string-template-org-json:0.21.0](https://central.sonatype.com/artifact/io.github.bitterfox/json-string-template-org-json)
- [Jackson](https://github.com/FasterXML/jackson)
  - [io.github.bitterfox:json-string-template-jackson:0.21.0](https://central.sonatype.com/artifact/io.github.bitterfox/json-string-template-jackson)
...
dependencies {
  implementation("io.github.bitterfox:json-string-template-jakarta-json:0.21.0")
  implementation("io.github.bitterfox:json-string-template-org-json:0.21.0")
  implementation("io.github.bitterfox:json-string-template-jackson:0.21.0")
}
```
